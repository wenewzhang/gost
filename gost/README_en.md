...
Google group: [https://groups.google.com/d/forum/wenewzhang](https://groups.google.com/d/forum/wenewzhang)
...
[https://github.com/wenewzhang/gost/releases](https://github.com/wenewzhang/gost/releases)

### install script

```bash
# install latest from [https://github.com/wenewzhang/gost/releases](https://github.com/wenewzhang/gost/releases)
bash <(curl -fsSL https://github.com/wenewzhang/gost/raw/master/install.sh) --install
```
```bash
# select version for install 
bash <(curl -fsSL https://github.com/wenewzhang/gost/raw/master/install.sh)
```

### From source

```
git clone https://github.com/wenewzhang/gost.git
cd gost/cmd/gost
go build
```
