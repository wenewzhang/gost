...
if [ "$1" = 'arm7' ]; then   
	export CC=/home/jimmy/Downloads/openwrt-toolchain-23.05.0-rc3-mvebu-cortexa9_gcc-12.3.0_musl_eabi.Linux-x86_64/toolchain-arm_cortex-a9+vfpv3-d16_gcc-12.3.0_musl_eabi/bin/arm-openwrt-linux-muslgnueabi-gcc
	export GOOS=linux
	export GOARCH=arm
	export GOARM=7
